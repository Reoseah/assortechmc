...
public class ElectricFurnaceBlockEntity extends ProcessingMachineBlockEntity<SmeltingRecipe> implements SidedInventory {
    ...
    public static <R extends Recipe<Inventory>> void tick(World world, BlockPos pos, BlockState state, ProcessingMachineBlockEntity<R> be) {
        ...
        AtRecipeBlockEntity.tick(world, pos, state, be);
    }
