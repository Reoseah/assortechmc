...
public abstract class MachineRecipe implements Recipe<Inventory> {
    ...
    public MachineRecipe(Identifier id, Ingredient input, int count, ItemStack output, int duration, float experience) {
        this.id = id;
        this.input = input;
        this.output = output;
        this.count = count;
    ...
    public static class Serializer<T extends MachineRecipe> implements RecipeSerializer<T> {
        @FunctionalInterface
        public interface Factory<T extends MachineRecipe> {
