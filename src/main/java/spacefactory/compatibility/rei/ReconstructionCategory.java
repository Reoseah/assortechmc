...
public class ReconstructionCategory implements DisplayCategory<ReconstructionDisplay> {
    private final CategoryIdentifier<? extends ReconstructionDisplay> id;
    private final EntryStack<?> logo;
    private final String name;

    public ReconstructionCategory(CategoryIdentifier<? extends ReconstructionDisplay> id, EntryStack<?> logo, String name) {
        this.id = id;
        this.logo = logo;
        this.name = name;
    }
    ...
    @Override
    public CategoryIdentifier<? extends ReconstructionDisplay> getCategoryIdentifier() {
        return this.id;
    }

    public DisplayRenderer getDisplayRenderer(ReconstructionDisplay display) {
        return SimpleDisplayRenderer.from(Collections.singletonList(display.getInputEntries().get(0)), display.getOutputEntries());
    }

    public List<Widget> setupDisplay(ReconstructionDisplay display, Rectangle bounds) {
    ...
    private int getEuTotal(ReconstructionDisplay display) {
