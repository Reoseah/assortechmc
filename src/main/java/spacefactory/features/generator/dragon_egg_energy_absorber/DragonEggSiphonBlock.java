...
public class DragonEggSiphonBlock extends InventoryBlock implements EU.ElectricBlock {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DragonEggEnergyAbsorberBlockEntity(pos, state);
    }

    @Override
    @Nullable
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, SpaceFactory.BlockEntityTypes.DRAGON_EGG_ENERGY_ABSORBER, DragonEggEnergyAbsorberBlockEntity::tick);
    }
