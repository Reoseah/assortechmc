package spacefactory.features.generator.dragon_egg_energy_absorber;
...
public class DragonEggEnergyAbsorberBlockEntity extends InventoryBlockEntity implements EU.Sender {
	public boolean generating = false, dragonEgg = false;

	public DragonEggEnergyAbsorberBlockEntity(BlockPos pos, BlockState state) {
		super(SpaceFactory.BlockEntityTypes.DRAGON_EGG_ENERGY_ABSORBER, pos, state);
	}
	...
	public static void tick(World world, BlockPos pos, BlockState state, DragonEggEnergyAbsorberBlockEntity be) {
