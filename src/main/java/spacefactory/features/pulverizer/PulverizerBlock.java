...
public class PulverizerBlock extends OrientableMachineBlock {
    public static final Text TOOLTIP = new TranslatableText("tooltip.spacefactory.energy_per_tick", SpaceFactory.config.pulverizerConsumption).formatted(Formatting.GRAY);
