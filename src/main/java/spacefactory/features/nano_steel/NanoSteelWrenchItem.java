...
public class NanoSteelWrenchItem extends WrenchItem implements FabricItem {
    public NanoSteelWrenchItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
