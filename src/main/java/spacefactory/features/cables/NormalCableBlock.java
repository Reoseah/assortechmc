package spacefactory.features.cables;
...
public class NormalCableBlock extends CableBlock {
    ...
    public NormalCableBlock(int radius, boolean insulated, Settings settings) {
        super(settings);
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        ...
        if (this == SpaceFactory.Blocks.COPPER_WIRE || this == SpaceFactory.Blocks.COPPER_CABLE) {
            tooltip.add(new TranslatableText("tooltip.spacefactory.energy_transfer", SpaceFactory.config.copperWireTransferRate).formatted(Formatting.GRAY));
        } else {
    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        ...
        if (be instanceof CableBlockEntity conduit) {
