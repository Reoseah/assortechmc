...
public class AtomicConstructorScreen extends HandledScreen<AtomicConstructorScreenHandler> {
    private static final Identifier TEXTURE = SpaceFactory.id("textures/gui/atomic_constructor.png");

    public AtomicConstructorScreen(AtomicConstructorScreenHandler handler, PlayerInventory inventory, Text title) {
