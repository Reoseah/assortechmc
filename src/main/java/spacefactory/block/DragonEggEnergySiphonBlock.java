...
public class DragonEggEnergySiphonBlock extends ContainerBlock {
    ...
    public DragonEggEnergySiphonBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DragonEggEnergySiphonBlockEntity(pos, state);
    }

    @Override
    @Nullable
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return world.isClient ? null : checkType(type, SpaceFactory.BlockEntityTypes.DRAGON_EGG_ENERGY_SIPHON, DragonEggEnergySiphonBlockEntity::tick);
    }
