...
public class EngineeringAIBlockEntity extends MachineBlockEntity implements SidedInventory {
    ...
    public EngineeringAIBlockEntity(BlockPos pos, BlockState state) {
        super(SpaceFactory.BlockEntityTypes.ENGINEERING_AI, pos, state);
    }
