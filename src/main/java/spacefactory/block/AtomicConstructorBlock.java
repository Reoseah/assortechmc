...
public class AtomicConstructorBlock extends MachineBlock {
    ...
    public AtomicConstructorBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new AtomicConstructorBlockEntity(pos, state);
    }
